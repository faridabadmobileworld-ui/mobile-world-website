          ...
          >
            {f.logo ? (
              /* पट्टी चलती रहती है, इसलिए logo "बाद में" नहीं आ सकते — वरना
                 खिसकते-खिसकते खाली जगह दिखती है। सातों मिलाकर 43 KB के हैं
                 और दोनों बार वही file है, इसलिए request भी सात ही जाती हैं।

                 ⚠️ 7 Sep 2026 को इन्हें `lazy` करके देखा गया था, यह सोचकर कि
                 ये hero की तस्वीर से bandwidth छीनते हैं। **नाप ने उल्टा
                 बताया** — home का LCP 1450ms से बढ़कर 1560ms हो गया। इसलिए
                 `eager` ही रहने दीजिए; यह अंदाज़ा नहीं, नापा हुआ है। */
