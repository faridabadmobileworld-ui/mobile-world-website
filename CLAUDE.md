...
### 🎞️ Home का hero video — नाप का पक्का नियम (8 Sep 2026)

इस एक चीज़ पर **तीन बार** ग़लती हुई और owner को तीन बार बताना पड़ा। इसलिए
नियम यहाँ लिख रहा हूँ — दोबारा मत तोड़िएगा।

**गणित पहले समझिए:** video 16:9 की है, phone सीधा (portrait) है। 390px चौड़ी
screen पर 16:9 की video सिर्फ़ **219px** ऊँची होती है। इसलिए ये तीनों बातें
एक साथ **असंभव** हैं:

| | |
|---|---|
| (क) hero पूरी screen भरे | |
| (ख) video का एक भी किनारा न कटे | |
| (ग) कोई काली पट्टी न दिखे | |

तीनों में से **कोई दो** ही मिल सकती हैं। जो कोशिशें हो चुकीं:

- `object-fit:contain` + बची हुई ऊँचाई भरना → (क)+(ख) मिले, **काली पट्टियाँ** बनीं ❌
- `object-fit:cover` + बची हुई ऊँचाई भरना → (क)+(ग) मिले, **video कट गई** ❌
- **डिब्बा ख़ुद 16:9 का** → (ख)+(ग) मिले ✅ — यही चुना गया है

**अब जो चल रहा है:** `.phv-stage` ख़ुद `aspect-ratio:16/9` का है और उसकी
चौड़ाई `min(100vw, बची हुई ऊँचाई × 16/9)` है। Video उसमें ठीक-ठीक बैठती है —
न कुछ कटता है, न कोई पट्टी बचती है। नीचे जो जगह बचती है वो **काली नहीं,
page का अपना सफ़ेद** है, और उसके बाद अगला हिस्सा आ जाता है।

📌 **19 Sep 2026 — owner ने तीनों में से "पूरी चौड़ाई" चुनी।** उनके शब्दों में:
*"CHHOTI SI AA RHI H YE BEECH ME. FULL WIDTH PE LAGAO 16:9 RATIO ME POORI
EDGE TO EDGE."* इससे पहले video की चौड़ाई बची हुई ऊँचाई से निकलती थी (1366px
की screen पर सिर्फ़ 690px), और दोनों तरफ़ गहरी पट्टी दिखती थी — owner को वही
"छोटी" लगी।

**अब जो चल रहा है:** `.phv-stage` की चौड़ाई **100vw** है और ऊँचाई उसी से
(56.25vw)। कुछ काटा नहीं जाता, कोई पट्टी नहीं बचती।

⚠️ **इसका सीधा नतीजा — यह गणित है, ग़लती नहीं:** 1366px चौड़ी screen पर पूरी
चौड़ाई की 16:9 video **768px** ऊँची होती है, जबकि header के नीचे जगह ~690px
बचती है। इसलिए पूरा frame एक ही नज़र में **नहीं** दिखता; ज़रा scroll करने पर
नीचे का हिस्सा और उसके नीचे की लिखाई आ जाती है।

**इसे सँभालने का तरीक़ा (`top: min(...)`):** चिपकने की जगह अब
`min(var(--phv-top), calc(100svh - video की ऊँचाई - लिखाई - 10px))` है।
Video screen से छोटी हुई तो header के ठीक नीचे चिपकती है; लंबी हुई तो पहले
इतनी सरकती है कि नीचे की लिखाई पूरी दिख जाए, फिर चिपकती है। यही इकलौता
तरीक़ा है जिससे **पूरी चौड़ाई भी मिले और लिखाई भी दिखे**, बिना एक pixel काटे।
इस सरकने में video का ऊपरी किनारा थोड़ी देर header के पीछे जाता है — पूरी
चौड़ाई माँगने पर यह टाला नहीं जा सकता।

⚠️ `width:100%` कभी मत लिखिए — ऊपर वाले डिब्बे में padding है, इसलिए video
किनारे से 16px अंदर रह जाती है (19 Sep को यही हुआ था)। हमेशा
`width:100vw; margin-inline:calc(50% - 50vw)`।

⚠️ **लेटी हुई phone screen इसका अपवाद है** — वहाँ पूरी चौड़ाई की 16:9 video
screen से ऊँची हो जाती है, इसलिए वहाँ लिखाई video के बग़ल में रहती है।

📌 **दस नाप पर जाँच का script** `scratchpad` में `hero6.mjs` जैसा बनाइए —
हर नाप पर जाँचिए: डिब्बे का ratio 16:9 है, video का डिब्बा stage के बराबर है
(यानी कोई पट्टी नहीं), frame ऊपर वाली पट्टी के नीचे से शुरू होता है, लिखाई
न video पर चढ़ती है न नीचे वाली पट्टी पर, और पूरी लिखाई चिपके हुए हिस्से के
अंदर रहती है। (19 Sep 2026 — 89/89 पास, `hero7.mjs`।)

⚠️ **`--phv-cap` हमेशा नापकर भरिए, अंदाज़े से नहीं।** यह वो जगह है जो लिखाई
के लिए छोड़ी जाती है, और video की चौड़ाई सीधे इसी से निकलती है। 18 Sep को
heading लंबी हुई तो phone पर लिखाई 495px की हो गई और दुकान का नाम नीचे वाली
पट्टी के पीछे छुप गया — screenshot से पकड़ा गया, नाप से ठीक हुआ।

### 🎬 Hero अब **हर screen पर** scroll से चलता है (18 Sep 2026)

Owner ने नई video भेजते हुए कहा: *"full screen par aaye wo 16:9 screen ratio
me. Scrolling me same effect aaya chahiye aage piche karte rhne par."*

पहले 1024px से बड़ी screen पर hero चिपकता ही नहीं था — वहाँ video अपने आप
चलती-दोहराती रहती थी। अब वहाँ भी वही ढाँचा है जो phone पर है: चिपकी हुई परत,
और scroll के हिसाब से video का frame आगे-पीछे। `globals.css` का **सबसे आख़िरी**
`@media(min-width:1024px)` block यही करता है — उसे ऊपर मत ले जाइएगा, वरना
पहले वाला `position:static` जीत जाएगा।

📌 **Video अब iPhone की नहीं, दुकान की है** — ख़ाली इमारत से शुरू होकर brand
के board, फिर लाल "Mobile World" वाला sign, और आख़िर में जगमगाती दुकान।
Files: `public/hero-shop/shop.mp4` (1.25 MB) · `shop-sm.mp4` (303 KB) ·
`shop.jpg`। पूरा तरीक़ा वहीं README में।

⚠️ **Headless Chromium में H.264 चलती ही नहीं** (`canPlayType` ख़ाली लौटाता है)।
इसलिए scroll वाली जाँच के लिए उसी video की एक VP9 `.webm` बनाकर Playwright के
